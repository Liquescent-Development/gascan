...
seed_repo() {
  ...
  for seed_path in Cargo.toml Cargo.lock crates/lib.rs helpers/helper.swift scripts/build-apple-attach-helper.sh scripts/workspace-image-source-digest.sh scripts/build-arca-engine.sh scripts/sync-arca-proto.sh engine/arca-pin.json engine/allowed-signers packaging/macos/package.sh LICENSE rust-toolchain.toml proto/gascan.proto images/workspace/Dockerfile images/workspace/approved-image.txt images/workspace/approved-source.sha256 images/workspace/versions.lock; do
...
classes=(rust-toolchain.toml proto/gascan.proto scripts/workspace-image-source-digest.sh scripts/sync-arca-proto.sh engine/arca-pin.json images/workspace/Dockerfile images/workspace/approved-image.txt images/workspace/approved-source.sha256 images/workspace/versions.lock)
