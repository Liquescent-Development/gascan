...
Task 7 integration: complete (head 306e0b6; final review findings resolved and independent review clean; bounded PTY resize asserts exact 47x132, bounded PTY signal handling propagates real-TTY SIGINT and rejects typed SIGTERM as a substitute, and cleanup/output regressions remain covered; Gate 4, Gate 5, and MVP remain pending)
