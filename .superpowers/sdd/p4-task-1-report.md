...
- `scripts/build-workspace-image.sh` rejects mutable base/tag inputs, downloads and verifies both artifacts, builds Linux ARM64, inspects the result, prints its OCI digest, and writes `.artifacts/workspace-image-ref`.
