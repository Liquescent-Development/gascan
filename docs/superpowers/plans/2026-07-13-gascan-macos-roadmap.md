...
| Plan 4 image/user/mise/Gascamp contracts | connected-build Tasks 1–4 are independently approved; Task 5 is partial and unaccepted with an approved unprivileged wrapper-context revision | approved through `b03add2`; partial `3517415` | finish Task 5 without changing the helper/sudoers contract, then execute Tasks 6–7 |
