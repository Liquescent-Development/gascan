...
| Plan 4 image/user/mise/Gascamp contracts | connected-build Tasks 1–5 and the Task 6 platform-neutral harness are independently approved; credentialed live image evidence remains | `feature/provisioning` harness through `30dd514`; no approved image | provide authorized external Gascamp credential, run/review live Task 6, then Task 7 |
...
- In progress: Phase 2 workspace image and provisioning integration;
  connected-build Tasks 1–5 and the Task 6 platform-neutral harness are
  approved through `30dd514`; Task 6 live evidence is pending.
