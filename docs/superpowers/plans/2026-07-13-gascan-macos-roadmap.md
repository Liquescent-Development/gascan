...
| Plan 4 image/user/mise/Gascamp contracts | connected-build Tasks 1–2 are independently approved; secret isolation is live-proven and the locked public context boundary is implemented | `feature/provisioning` through `1878744`, `docs/evidence/apple-build-secret.md` | execute connected-build Tasks 3–7 and run the live image smokes |
...
- In progress: Phase 2 workspace image and provisioning integration;
  connected-build Tasks 1–2 are approved through `1878744`.
