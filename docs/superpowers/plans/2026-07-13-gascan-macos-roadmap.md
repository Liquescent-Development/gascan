...
| Plan 4 image/user/mise/Gascamp contracts | connected-build Tasks 1–4 are independently approved; Task 5 is partial and unaccepted pending a privileged snapshot/secret-staging interface decision | approved through `b03add2`; partial `3517415` | resolve the helper/sudoers boundary, finish Task 5 review, then execute Tasks 6–7 |
